...
var signup_schema_exports = {};
__export(signup_schema_exports, {
  signUpSchema: () => signUpSchema
});
module.exports = __toCommonJS(signup_schema_exports);
var import_joi = __toESM(require("joi"));
var signUpSchema = import_joi.default.object({
  email: import_joi.default.string().email().required(),
  password: import_joi.default.string().pattern(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/).required(),
